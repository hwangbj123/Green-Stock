...
<link href="https://fonts.googleapis.com/css2?family=Jua&display=swap"
	rel="stylesheet">
<link
	href="https://fonts.googleapis.com/css2?family=Cute+Font&family=Hi+Melody&display=swap"
	rel="stylesheet">
...
<body>
	<header class="ec-header"
		style="position: relative !important; z-index: 200 !important">
		<!-- Header Start -->
					...
					<div class="ec-flex">
						...
						<div class="align-self-center">
							<div class="header-logo">
								<a href="/main"><img src="/resources/img/G_logo.jpg"
									alt="/resources/img/G_logo.jpg" /></a>
							</div>
						</div>
						<!-- Header Logo End -->
						...
						<div class="align-self-center">
							<div class="header-search">
								<form class="ec-btn-group-form" action="/stock/domestic"
									method="get">
									<input class="form-control ec-search-bar" name="searchData"
										placeholder="종목명을 입력해주세요" type="text" required="required" />
						...
						<div class="align-self-center">
							<div class="ec-header-bottons">
								...
								<c:if test="${empty principal}">
									<li><a href="http://localhost/user/sign-in"
										style="display: flex; align-items: center" class="login_btn"><span><i
												class="fa-solid fa-arrow-right-to-bracket"></i></span><span>&nbsp;&nbsp;</span><span
											class="btn_label">로그인</span></a></li>
									<li><a href="http://localhost/user/sign-up"
										class="signIn_button"
										style="display: flex; align-items: center"><span><i
												class="fa-solid fa-user-plus"></i></span><span>&nbsp;&nbsp;</span><span
											class="btn_label">회원가입</span></a></li>
								</c:if>
								<c:if test="${principal.roletypeId == 1}">
										...
										<ul>
											<li class="dropdown"><a href="javascript:void(0)"
												style="display: flex; align-items: center;"><i
													class="fa-solid fa-house-user"></i><span>&nbsp;&nbsp;</span><span
													class="btn_label">내 정보</span></a>
									...
									<li
										style="text-align: center; display: flex; align-items: center; margin-left: 0px;">
										<a href="http://localhost/user/sign-out"
										style="display: flex; align-items: center;"
										class="signIn_button"><span><i
												class="fa-solid fa-person-walking-dashed-line-arrow-right"></i></span><span>&nbsp;&nbsp;</span><span
											class="btn_label">로그아웃</span></a>
									</li>
								</c:if>
								<c:if test="${principal.roletypeId == 0}">
									<li><a href="http://localhost/admin/main"
										style="display: flex; align-items: center" class="login_btn"><span><i
												class="fa-solid fa-screwdriver-wrench"></i></span><span>&nbsp;&nbsp;</span><span
											class="btn_label">관리자 페이지</span></a></li>
									<li><a href="http://localhost/user/sign-out"
										style="display: flex; align-items: center"
										class="signIn_button"><span><i
												class="fa-solid fa-person-walking-dashed-line-arrow-right"></i></span><span>&nbsp;&nbsp;&nbsp;</span><span
											class="btn_label">로그아웃</span></a></li>
								</c:if>
							</div>
						</div>
					</div>
		...
		<div class="ec-header-bottom d-lg-none">
			<div class="container position-relative">
				<div class="row">
					...
					<div class="col">
						<div class="header-logo">
							<a href="index.html"><img src="/resources/img/G_logo.jpg"
								alt="Site Logo" /></a>
						</div>
					</div>
					<!-- Ec Header Logo End -->
					...
					<div class="col-md-12 align-self-center">
						<div class="ec-main-menu">
							<ul style="z-index: 1;">
								...
								<li class="dropdown"><a href="javascript:void(0)">주식전문가</a>
									<ul class="sub-menu">
										<li><a href="/advisor/list">주식 전문가 리스트</a></li>
										<li><a href="/advisor/register">전문가 신청</a></li>
									</ul></li>
								<li class="dropdown"><a href="/board/list">커뮤니티</a>
									<ul class="sub-menu">
